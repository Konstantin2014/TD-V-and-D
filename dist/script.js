...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var modalState = {}; // переменная, которая является состоянием модального окна
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState); // modalState чтобы отправляемая форма знала о тех данных
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])("#width"); // валидируем данные введенные в поля

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])("#height"); // валидируем данные введенные в поля
  ...
  function bindActionToElems(event, elem, prop) {
    ...
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        switch (item.nodeName // в зависимости от того элемента на который кликнул пользователь совершаем разные операции
        ) {
          case "SPAN":
            state[prop] = i;
            break;
...
var forms = function forms(state) {
  ...
  var inputs = document.querySelectorAll("input"); // для очистки всех inputs

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); // проверка на ввод цифр
  ...
  form.forEach(function (item // перебираем все формы и навешиваем обработчик события submit
  ) {
    return item.addEventListener("submit", function (event) {
      event.preventDefault(); // создаем пользователю блок с сообщением

      var statusMessage = document.createElement("div");
      statusMessage.classList.add("status");
      item.appendChild(statusMessage);
      var formData = new FormData(item); // собираем все данные из введенной формы
...
var modals = function modals() {
  ...
  triggerSelector, modalSelector, closeSelector) {
    ...
    var windows = document.querySelectorAll("[data-modal]"); // для получения все хмодальных окон чтобы их впоследствии закрыть
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener("click", function (event) {
    ...
    if ( // проверяем что мы кликнули в один из tab-ов, т к могут быть и другие элементы
    target && (target.classList.contains(tabSelector.replace(/\./, "")) || // т к мы передаем класс, то нуно убрать точку
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    // ф-ция выдает время до конца акции
  ...
  var setClock = function setClock(selector, endtime) {
    // помещение определенного момента в определенные элементы на странице
    ...
    function updateClock() {
      // определяет сколько времени осталось до дэдлайна
